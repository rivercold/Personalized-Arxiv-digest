...
def greet(email, subject, physics_subject, subsubjects, interest):
    print(subject, physics_subject, subsubjects)
    if subject == "Physics":
...
with gr.Blocks() as demo:
    ...
    greet_btn = gr.Button("Subscribe")
    output = gr.Textbox(label="Output Box")
    greet_btn.click(fn=greet, inputs=[email, subject, physics_subject, subsubject, interest], outputs=output, api_name="greet")
